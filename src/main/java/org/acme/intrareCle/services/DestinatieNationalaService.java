...
@Service
public class DestinatieNationalaService {
    public final String STARE_FABRICATIE = "0";

    private static final Logger logger = LoggerFactory.getLogger(DestinatieNationalaService.class);

    public IntrareCLE destinatieNationala(IntrareCLE intrareCle) {
        ...
        logger.info("Ramura Destinatie Nationala"
