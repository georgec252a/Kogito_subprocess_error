...
@Service
public class UserTaskCautaLocService {
    public final String STARE_FABRICATIE = "0";

    private static final Logger logger = LoggerFactory.getLogger(UserTaskCautaLocService.class);

    public IntrareCLE cautaLoc(IntrareCLE intrareCle) {
        ...
        logger.info("User Task - Aici se introduce loc pana la gasirea unui loc liber");
