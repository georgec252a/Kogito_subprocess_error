...
@Service
public class SolicitaInfoPlataService {
    public final String STARE_FABRICATIE = "0";

    private static final Logger logger = LoggerFactory.getLogger(SolicitaInfoPlataService.class);

    public IntrareCLE solicitaInfoPlata(IntrareCLE intrareCle) {
        ...
        logger.info("Solicita info plata"
