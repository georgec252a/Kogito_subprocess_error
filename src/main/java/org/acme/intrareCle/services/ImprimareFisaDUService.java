...
@Service
public class ImprimareFisaDUService {
    public final String STARE_FABRICATIE = "0";

    private static final Logger logger = LoggerFactory.getLogger(ImprimareFisaDUService.class);

    public IntrareCLE imprimare(IntrareCLE intrareCle) {
