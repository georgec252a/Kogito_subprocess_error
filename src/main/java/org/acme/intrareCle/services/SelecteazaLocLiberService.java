...
@Service
public class SelecteazaLocLiberService {
    public final String STARE_FABRICATIE = "0";

    private static final Logger logger = LoggerFactory.getLogger(SelecteazaLocLiberService.class);

    public IntrareCLE selecteazaLocLiber(IntrareCLE intrareCle) {
        ...
        logger.info("Aici se selecteaza un loc liber pt vn-ul "
                + intrareCle.getVin() + ", cu marca sofer " + intrareCle.getMarcaSofer());
