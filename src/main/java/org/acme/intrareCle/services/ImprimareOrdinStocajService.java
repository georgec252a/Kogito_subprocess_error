...
@Service
public class ImprimareOrdinStocajService {
    public final String STARE_FABRICATIE = "0";

    private static final Logger logger = LoggerFactory.getLogger(ImprimareOrdinStocajService.class);
    ...
    public IntrareCLE cereInfo(IntrareCLE intrareCle) {
        ...
        logger.info("Ordin de Stocaj se Imrima!!! ");
