...
@Service
public class FluxDirectService {
    public final String STARE_FABRICATIE = "0";

    private static final Logger logger = LoggerFactory.getLogger(FluxDirectService.class);

    public IntrareCLE fluxDirect(IntrareCLE intrareCle) {
        ...
        logger.info("Ramura Flux Direct"
